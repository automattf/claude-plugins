...
A marketplace of Claude Code plugins by [automattf](https://github.com/automattf).
...
### [automatic-episodic-memory](https://github.com/automattf/automatic-episodic-memory)
